...
namespace EDoc2.Core
{
    ...
    public class DockingHttpClient : IDockingHttpClient, ITransient
    {
        ...
        public async Task<T> GetEntityAsync<T>(string url, Dictionary<string, string> parameter = null, Dictionary<string, string> heads = null)
        {
            ...
            var re = (await resultGet.Content.ReadAsStringAsync());
        ...
        /// <param name="heads"></param>
        /// <returns></returns>
        public async Task<dynamic> GetToStreamAsync(string url, Dictionary<string, string> parameter = null, Dictionary<string, string> heads = null)
        {
            var client = _httpClient;
            if (heads == null)
            {
            ...
            return await resultGet.Content.ReadAsStreamAsync();
        }
