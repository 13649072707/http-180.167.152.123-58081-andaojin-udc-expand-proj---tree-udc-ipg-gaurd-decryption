(function (window) {
    window.edoc2Cryptography = (function (window) {
        ...
        _encryptOperation.prototype = (function () {
            ...
            var getKey = function () {
                if (!__key) {
                    __key = stringToHex(des("macrowing", "macrowing", 1, 0));
                }
                return __key;
            };
            ...
            return {
                ...
                encryptData: function (s) {
                    ...
                    return stringToHex(des(getKey(), s, 1, 0));
                },
                ...
                decryptData: function (s) {
                    if (!s || s.length == 0) return "";
                    return des(getKey(), HexTostring(s), 0, 0);
                }
            };
        })();
