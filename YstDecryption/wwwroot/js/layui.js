...
layui.define(["jquery", "lay"], function(e) {
	...
	F.prototype.config = {
		...
		format: "hex",
		predefine: !1,
		colors: ["#009688", "#1890ff", "#1E9FFF", "#FF5722", "#FFB800", "#01AAED", "#999", "#c00", "#ff8c00", "#ffd700", "#90ee90", "#00ced1", "#1e90ff", "#c71585", "rgb(0, 186, 189)", "rgb(255, 120, 0)", "rgb(250, 212, 0)", "#393D49", "rgba(0,0,0,.5)", "rgba(255, 69, 0, 0.68)", "rgba(144, 240, 144, 0.5)", "rgba(31, 147, 255, 0.73)"]
	}, F.prototype.render = function() {
		var e = this,
			r = e.config,
					...
					return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function(a, l) {
							...
							"array" === layui._typeof(l) && 0 === l.length || (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
								...
								if (void 0 !== g && null !== g || (g = ""), !r.colGroup) {
									...
									var b = ['<td data-field="' + f + '" data-value="' + g + '" data-key="' + m + '" ' + function() {
										var e = [];
