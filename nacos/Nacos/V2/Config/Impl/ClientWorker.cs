namespace Nacos.V2.Config.Impl
{
    ...
    public class ClientWorker : IDisposable
    {
        ...
        public Task<string> GetServerConfig(int pageNo, int pageSize, string tenant, long readTimeout, bool notify)
        {
            if (pageNo <= 0) pageNo = 1;
            if (pageSize <= 0) pageSize = 10;
            return this._agent.QueryConfigAsync(pageNo, pageSize, tenant, readTimeout, notify);
        }
    }
}
