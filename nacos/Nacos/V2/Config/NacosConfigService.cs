namespace Nacos.V2.Config
{
    ...
    public class NacosConfigService : INacosConfigService
    {
        ...
        public async Task<string> GetConfig(int pageNo, int pageSize, string tenant, long readTimeout)
            =>await _worker.GetServerConfig(pageNo, pageSize, tenant, readTimeout, false).ConfigureAwait(false);
