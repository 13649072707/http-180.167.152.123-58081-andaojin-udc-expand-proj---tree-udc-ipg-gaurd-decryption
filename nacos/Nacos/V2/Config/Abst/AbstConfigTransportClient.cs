namespace Nacos.V2.Config.Abst
{
    ...
    public abstract class AbstConfigTransportClient : IConfigTransportClient
    {
        ...
        public Task<string> QueryConfigAsync(int pageNo, int pageSize, string tenant, long readTimeout, bool notify)
            => QueryConfig(pageNo,pageSize,tenant,readTimeout,notify);
        ...
        protected abstract Task<string> QueryConfig(int pageNo, int pageSize, string tenant, long readTimeout, bool notify);
